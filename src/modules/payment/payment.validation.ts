...
export class PaymentValidation {
  static readonly CREATE = z.object({
    orderId: z.coerce.number().int().positive({ message: 'Order ID must be a positive integer.' }),
    ...
    paymentProof: z.any().optional().nullable(),
    metadata: z.record(z.any()).optional().nullable(),
  });

  static readonly UPDATE = z.object({
    orderId: z.coerce.number().int().positive({ message: 'Order ID must be a positive integer.' }).optional(),
